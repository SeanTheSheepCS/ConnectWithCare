...
enum ServerMessageCode   {SERVERMESSAGECODE_LOGINAUTH = 0x00,
						  ...
						  SERVERMESSAGECODE_CHANGEUSERNAME = 0x30,
						  SERVERMESSAGECODE_CHANGEPASSWORD = 0x31,
						  SERVERMESSAGECODE_CHANGEACCOUNTTYPE = 0x32,
						  SERVERMESSAGECODE_DELETEACCOUNT = 0x33
                        };
