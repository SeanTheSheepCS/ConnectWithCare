#include "SendUserMessageImageMessage.h"

#include "../../../UserMessages/UserMessage.h"

SendUserMessageImageMessage::SendUserMessageImageMessage(const unsigned long int lengthArg, const unsigned char* messageAsCharArrayArg) : ClientBasicMessage(lengthArg, messageAsCharArrayArg)
{
...
SendUserMessageImageMessage::SendUserMessageImageMessage(const SendUserMessageImageMessage& other) : ClientBasicMessage(other)
{
	this->theUserMessage = new UserMessage(other.getUserMessage());
}

SendUserMessageImageMessage& SendUserMessageImageMessage::operator=(const SendUserMessageImageMessage& rhs)
{
	if(this != &rhs)
	{
...
SendUserMessageImageMessage::~SendUserMessageImageMessage()
{
	delete theUserMessage;
}

const UserMessage SendUserMessageImageMessage::getUserMessage() const
{
